...
async function loadContract(web3) {
    ...
    },
    {
      ...
      "type": "function"
        ...
        var contractAddress = '0xaF48B78A882695dE79fcF30E280D1211cB782c97'; // Replace with your contract address
...
async function fetchBillsData() {
    try {
        const response = await fetch('get_mbills.php');
...
async function main() {
    try {
        ...
        for (const bill of bills) {
            await contract.methods.addMedicalBill(bill.patientId, bill.username, bill.billType, bill.amount).send({ from: "0xDbAdaB25058aeA8EBbF57F4ea6F8445E0BdE06a2", gas: 500000 });
